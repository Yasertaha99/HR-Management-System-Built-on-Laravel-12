            ...
            <ul>
                ...
                <li class="{{set_active(['all/employee/list','all/employee/list','all/employee/card','form/holidays/new','form/leaves/new',
                    ...
                    <ul style="{{ request()->is('/*') ? 'display: block;' : 'display: none;' }}">
                        ...
                        <li><a class="{{set_active(['payroll/dashboard'])}}" href="{{ route('payroll.dashboard') }}"><i class="fa fa-money text-warning mr-1"></i> Payroll Dashboard</a></li>
                        <li><a class="{{set_active(['payroll/payslips'])}}" href="{{ route('payroll.payslips') }}"><i class="fa fa-file-text-o text-info mr-1"></i> My Payslips</a></li>
